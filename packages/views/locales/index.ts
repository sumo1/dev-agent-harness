...
import enWorkingDirs from "./en/working-dirs.json";
...
import zhHansWorkingDirs from "./zh-Hans/working-dirs.json";
...
import koWorkingDirs from "./ko/working-dirs.json";
...
import jaWorkingDirs from "./ja/working-dirs.json";
...
export const RESOURCES: Record<SupportedLocale, LocaleResources> = {
  ...
  "zh-Hans": {
    ...
    "working-dirs": zhHansWorkingDirs,
